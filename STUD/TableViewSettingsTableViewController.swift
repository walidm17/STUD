//
//  TableViewSettingsTableViewController.swift
//  STUD
//
...
class TableViewSettingsTableViewController: UITableViewController {
    private let reuseIdentifier: String = "myAccount"
